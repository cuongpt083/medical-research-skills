---
name: drug-research
description: Produce verified drug/biologic therapeutic intelligence by separating
  regulatory facts, labeling, safety, efficacy evidence, and investigational status.
trigger: 'Use for questions about: - approval/authorization; - indication; - dosing/administration;
  - contraindications/warnings; - safety signals; - interactions; - efficacy; - off-label
  or investigational uses; - new drugs or label expansions.'
tags:
- medical-research
- evidence
---

> Source of truth: `skills/drug-research/SKILL.md`
>
